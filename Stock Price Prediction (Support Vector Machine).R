...
ggplot() +
  ...
  theme(text = element_text(size = 25), plot.margin = ggplot2::margin(10, 15, 10, 10, "point"))
...
## Part 9.4
result_radial_gamma_1

result_radial_gamma_2

result_radial_gamma_3

result_radial_gamma_4
...
ggplot() +
  ...
  theme(text = element_text(size = 25)) +
  theme(legend.position = c(0.91, 0.125), legend.text = element_text(size = 25), legend.title = element_text(size = 25), plot.title = element_text(hjust = 0.5), plot.margin = ggplot2::margin(10, 15, 10, 10, "point"))
...
ggplot() +
  ...
  ylab("2nd Principal Component") + xlab("1st Principal Component") +
  theme(text = element_text(size = 25)) +
  theme(legend.position = c(0.89, 0.225), legend.text = element_text(size = 25), legend.title = element_text(size = 25), plot.title = element_text(hjust = 0.5), plot.margin = ggplot2::margin(10, 15, 10, 10, "point"))
